...
app.config(['$routeProvider', '$locationProvider', '$translateProvider', function ($routeProvider, $locationProvider, $translateProvider) {
    $translateProvider.useStaticFilesLoader({'prefix': '/locales/locale-', 'suffix': '.json'});
    $routeProvider.when("/", {templateUrl: '/templates/home.html', controller: 'homeController'});
    $routeProvider.when("/:lang/", {templateUrl: '/templates/home.html', controller: 'homeController'});
    ...
    $routeProvider.when("/:lang/blog", {templateUrl: '/templates/blog.html', controller: 'blogController'});
    $routeProvider.when("/:lang/blog/:slug", {templateUrl: '/templates/article.html', controller: 'articleController'});
...
app.controller('mainController', ['$http', '$routeParams', '$scope', '$rootScope', '$sce', 'mainService', function ($http, $routeParams, $scope, $rootScope, $sce, mainService) {
    ...
    $scope.menuLinks = {
        smartphones: [{title: 'Nexus 6P', slug: 'nexus-6p'}, {title: 'G6', slug: 'g6'}, {
            title: 'G730',
            slug: 'g730'
        }, {title: 'Honor 3', slug: 'honor3'}, {title: 'Honor 3X', slug: 'honor-3x'}, {
            title: 'Honor 4C',
            slug: 'honor-4c'
        }, {title: 'Honor 4X', slug: 'honor-4x'}, {title: 'Honor 7', slug: 'honor-7'}, {
            title: 'P8 lite',
            slug: 'nexus-6p'
        }, {title: 'P8', slug: 'p8'}, {title: 'P6 S', slug: 'p6-s'}, {title: 'Y220', slug: 'y220'}, {
            title: 'Y330',
            slug: 'y330'
        }, {title: 'Y541', slug: 'y541'}, {title: 'Y625', slug: 'y625'}, {title: 'Honor 5X', slug: 'honor-5x'}],
        tablets: [{title: 'MediaPad X1', slug: 'mediapad-x1'}, {
            title: 'MediaPad T1 7 3G',
            slug: 'mediapad-t1-7'
    ...
    $rootScope.leftMenu = {
        visible: false, opened: {products: false, abouts: false}, toggle: function (target) {
            ...
            $timeout(function () {
                if (scope.$last === true) {
                    ...
                    owl.owlCarousel({
                        ...
                        dots: false,
                        navigation: true,
                        navigationText: ["<img class=\"prod-arrow-left\" src='/img/other/arrow_dark_left.png'>", "<img class=\"prod-arrow-right\" src='/img/other/arrow_dark_right.png'>"],
                        autoplay: true,
                        autoplayTimeout: 5000,
                        autoplayHoverPause: true
                    });
