...
module.exports = function (app, fs) {
    app.post('/api/getProducts',function (req, res) {
        ...
        if(req.body.type == 's') {
            products = [
                {
                    title: "Huawei P6S", description: "", status: ' ', statusText: ' ', img: "/img/main-products/p6s.jpg", slug: "p6s"
                },
                {
                    title: "Honor 3", description: "", status: ' ', statusText: ' ', img: "/img/main-products/honor-3.jpg", slug: "honor-3"
                },
                {
                    title: "Huawei G6", description: "", status: ' ', statusText: ' ', img: "/img/main-products/g6-3g.jpg", slug: "g6-3g"
                },
                {
                    title: "Huawei Y220", description: "", status: ' ', statusText: ' ', img: "/img/main-products/y220.jpg", slug: "y220"
                },
                {
                    title: "Honor 4C Pro", description: "", status: ' ', statusText: ' ', img: "/img/main-products/4c-pro.png", slug: "4c-pro"
                },
                {
                    title: "Huawei G730", description: "", status: ' ', statusText: ' ', img: "/img/main-products/g730.jpg", slug: "g730"
                },
                {
                    title: "Huawei P9 Lite", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/p9-lite.jpg", slug: "p9-lite"
                },
                {
                    title: "Huawei P9", description: "", status: ' ', statusText: ' ', img: "/img/main-products/p9.jpg", slug: "huawei-p9"
                },
                {
                    title: "Honor 5X", description: "", status: ' ', statusText: ' ', img: "/img/main-products/honor-5x.png", slug: "honor-5x"
                },
                {
                    title: "Huawei Y5 II", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/y5ii.jpg", slug: "y5ii"
                },
                {
                    title: "Huawei Y3 II", description: "", status: ' ', statusText: ' ', img: "/img/main-products/y3ii.png", slug: "huawei-y3ii"
                },
                {
                    title: "Honor 5C", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/honor-5c.jpg", slug: "honor-5c"
                },
                {
                    title: "Huawei GR3", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/honor-5c.jpg", slug: "gr3"
                },
                // {
                ...
                // },
                {
                    title: "Huawei Y6 II", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/y6ii.jpg", slug: "y6ii"
                }
            ];
            ...
            products = [
                {
                    title: "Huawei MediaPad X1", description: "", img: "/img/main-products/mediapad-x1-7-0.jpg", slug: "mediapad-x1-7"
                },
                {
                    title: "Huawei MediaPad T1 7.0", description: "", img: "/img/main-products/mediapad-t1-7-0.jpg", slug: "mediapad-t1-7-0"
                },
                {
                    title: "Huawei MediaPad T1 8.0", description: "", img: "/img/main-products/mediapad-t1-8-0.jpg", slug: "mediapad-t1-8-0"
                }
            ];
            res.send(products).end();
        }
    ...
    app.post('/api/getArticle',function (req, res) {
        var path = './data/blog/'+ req.body.lang + '-' + req.body.slug + '.json';
        fs.readFile(path, 'utf8', function (err, data) {
            if (err) {
                console.error(err);
