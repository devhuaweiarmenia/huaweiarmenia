        ...
        switch(req.body.lang) {
            ...
            case 'ru':
                articles = [
                    ...
                    {
                        title: "Выбирая смартфон, мы руководствуемся наличием суммы, предназначенной для данной покупки, и нaшими представлениями о технике. На первый взгляд, это, казалось бы, простое решение, на самом деле, не всегда является таковым. Что выбрать? Как выбрать? В действительности, правильный выбор делается в результате сравнения. Желаете сделать правильный выбор?  Для сравнения и осуществления выбора посредстом данного сравнения, давайте ознакомимся со следующими 7 пунктами.", text: "", date: '24.08.2016', img: '7_reasons_to_choose_huawei/Image.jpg', slug: '11_facts_about_huawei'
                    }
                ];
                break;
            case 'hy':
