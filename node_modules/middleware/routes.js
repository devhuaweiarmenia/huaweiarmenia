    ...
    app.post('/api/getProducts',function (req, res) {
        ...
        if(req.body.type == 's') {
            products = [
                ...
                {
                    title: "Honor 4C Pro", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/4c-pro.png", slug: "4c-pro"
                },
                {
                    title: "Huawei G730", description: "", status: ' ', statusText: ' ', img: "/img/main-products/g730.png", slug: "g730"
                },
                {
                    title: "Huawei P9 Lite", description: "", status: ' ', statusText: '', img: "/img/main-products/p9-lite.png", slug: "p9-lite"
                },
                {
                    title: "Huawei P9", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/p9.png", slug: "huawei-p9"
                },
                {
                    title: "Honor 5X", description: "", status: ' ', statusText: ' ', img: "/img/main-products/honor-5x.png", slug: "honor-5x"
                },
                {
                    title: "Huawei Y5 II", description: "", status: ' ', statusText: ' ', img: "/img/main-products/y5ii.png", slug: "y5ii"
                },
                {
                    title: "Huawei Y3 II", description: "", status: 'new', statusText: 'Coming Soon', img: "/img/main-products/y3ii.png", slug: "huawei-y3ii"
                },
                {
        ...
        switch (from) {
            ...
            case 'product':
                ...
                builderObject.seo = {
                    title1: "Huawei Armenia",
                    title2: prod.title,
                    meta_description: prod.description["" + lang],
                    // meta_keywords: keywords["" + lang],
                    url: 'http://' + req.hostname + '' + req.url,
                    img: 'http://' + req.hostname + '/img/' + prod.slug + '/' + prod.img,
                    hostname: 'http://' + req.hostname + '',
                    lang_links: [{
                        href : 'http://' + req.hostname + '/en/' + req.url.slice(4),
                        lang : 'en'
            ...
            case 'article':
                var productS = {
                    "11_facts_about_huawei": {
                        title: {
                            hy: "11 փաստ, որոնք իմանալով հնարավոր չէ չսիրել Huawei-ը",
                            ru: "11 фактов которые вы незнали о Huawei",
                            en: "Why It's Impossible not to Love Huawei : 11 Facts."
                        },
                        description: {
                            hy: "Ցանկանո՞ւմ եք ծանոթանալ Huawei-ի մասին այնպիսի փաստերի, որոնք կփոխեն ձեր պատկերացումները չինական ընկերությա մասին: Ձեզ ենք ներկայացնում բազմաթիվ փաստերից միայն 11-ը:",
                            ru: "Желаете ознакомиться с фактами о Huawei, которые изменят ваше представление о китайской компании? Предоставляем вам из многочисленных фактов лишь следующие 11:",
                            en: "Below are 11 facts about Huawei out of many that will change you perception of this Chinese company."
                        },
                        img: "1.png",
                        slug: "11_facts_about_huawei"
                    },
                    "7_reasons_to_choose_huawei": {
                        title: {
                            hy: "7 համեմատություն, ինչից հետո դուք կցանկանաք ընտրել Huawei սմարթֆոն եւ ոչ թե Apple կամ Samsung:",
                            ru: "7 сравнений, после которых вы захотите выбрать Huawei вместо Apple или Samsung.",
                            en: "7 facts which will make you choose Huawei over Apple and Samsung."
                        },
                        description: {
                            hy: "Ցանկանում եք կատարել ճի՞շտ ընտրություն:Համեմատելու եւ համեմատության միջոցով ընտրություն կատարելու համար եկեք ծանոթանանք այս 7 կետերին",
                            ru: "Желаете сделать правильный выбор? Для сравнения и осуществления выбора посредстом данного сравнения, давайте ознакомимся со следующими 7 пунктами:",
                            en: "Do you want to make the right choice? Then lets take a look  on these 7 main comparison points which will help you with decission."
                        },
                        img: "Image.jpg",
                        slug: "7_reasons_to_choose_huawei"
                    }
                };
                var prod = productS[""+req.route.slug];
                builderObject.seo = {
                    title1: "Huawei Armenia",
                    title2: prod.title["" + lang],
                    meta_description: prod.description["" + lang],
                    // meta_keywords: keywords["" + lang],
                    url: 'http://' + req.hostname + '' + req.url,
                    img: 'http://' + req.hostname + '/img/blog/' + prod.slug + '/' + prod.img,
                    hostname: 'http://' + req.hostname + '',
                    lang_links: [{
                        href : 'http://' + req.hostname + '/en/' + req.url.slice(4),
                        lang : 'en'
